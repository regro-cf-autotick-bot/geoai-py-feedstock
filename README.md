...
pixi add geoai geoai-py
# for installing globally
pixi global install geoai geoai-py
```
...
It is possible to list all of the versions of `geoai` available on your platform:
...
```
pixi search geoai --channel conda-forge
```
